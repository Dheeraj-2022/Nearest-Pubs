...
IMAGE_PATH1 = os.path.join(IMAGE_PATH, "pexels-mike-yakaites-2585614.jpg")
...
choice = st.selectbox('', ('Total pubs in UK', 'Head',
                      'Tail', 'unique local authority', 'null_values'))
...
if choice == 'Total pubs in UK':
    ...
    st.text(
        f'Total no of pub local authority is {len(df.local_authority.unique())} in UK')
...
# subheader
st.write('By: :green[S Dheeraj Reddy]')

btn_click = st.button("Click me")

if btn_click == True:
    st.markdown(":lightblue[Connect with me ]")
    st.write(":blue[LinkedIn]:(https://www.linkedin.com/in/dheerajreddy20/)")

    st.write(":green[GitHub]:(https://github.com/Dheeraj-2022)")
